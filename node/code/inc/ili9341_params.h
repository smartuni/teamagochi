...
#define ILI9341_PARAM_IF_SPI                                  \
  .spi = ILI9341_PARAM_SPI, .spi_clk = ILI9341_PARAM_SPI_CLK, \
...
#define ILI9341_PARAM_IF_PAR                              \
  .d0_pin = ILI9341_PARAM_D0, .d1_pin = ILI9341_PARAM_D1, \
  .d2_pin = ILI9341_PARAM_D2, .d3_pin = ILI9341_PARAM_D3, \
  .d4_pin = ILI9341_PARAM_D4, .d5_pin = ILI9341_PARAM_D5, \
  .d6_pin = ILI9341_PARAM_D6, .d7_pin = ILI9341_PARAM_D7, \
  .wrx_pin = ILI9341_PARAM_WRX, .rdx_pin = ILI9341_PARAM_RDX,
#else
#define ILI9341_PARAM_IF_PAR
#endif

#if MODULE_LCD_PARALLEL_16BIT || DOXYGEN
/** Additional default interface params if MCU 8080 16-bit parallel interface is
 * enabled */
#define ILI9341_PARAM_IF_PAR_16BIT                            \
  .d8_pin = ILI9341_PARAM_D8, .d9_pin = ILI9341_PARAM_D9,     \
  .d10_pin = ILI9341_PARAM_D10, .d11_pin = ILI9341_PARAM_D11, \
  .d12_pin = ILI9341_PARAM_D12, .d13_pin = ILI9341_PARAM_D13, \
  .d14_pin = ILI9341_PARAM_D14, .d15_pin = ILI9341_PARAM_D15,
#else
#define ILI9341_PARAM_IF_PAR_16BIT
#endif
...
#define ILI9341_PARAMS                                                      \
  {                                                                         \
    ...
    ILI9341_PARAM_IF_PAR_16BIT.cs_pin = ILI9341_PARAM_CS,                   \
    .dcx_pin = ILI9341_PARAM_DCX, .rst_pin = ILI9341_PARAM_RST,             \
    .rgb = ILI9341_PARAM_RGB, .inverted = ILI9341_PARAM_INVERTED,           \
    .lines = ILI9341_PARAM_NUM_LINES,                                       \
    .rgb_channels = ILI9341_PARAM_RGB_CHANNELS,                             \
    .rotation = ILI9341_PARAM_ROTATION, .offset_x = ILI9341_PARAM_OFFSET_X, \
